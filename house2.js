...
canvas_download.download="house-2.jpeg";
...
var pos2 = new THREE.Vector3(-7, 10, 2);
...
label2_a.rotation.y = Math.PI * 0.5;
...
this.style.border="7px solid white";
}
...
var pos_anno_6 = new THREE.Vector3(19.5, 9.4, -6);
...
label2_a_5.rotation.x = Math.PI * 0;
...
label2_a_2.rotation.y = Math.PI * 0.9;
...
var pos_anno_5 = new THREE.Vector3(14, 7.7, -17);
...
label2_a_4.rotation.x = Math.PI * 0;
...
div_anno_i_6.onpointerdown=async function() {
      document.getElementsByClassName("container")[0].style.display="flex";
...
div_anno_i.onpointerdown=async function() {
      document.getElementsByClassName("container")[0].style.display="flex";
...
div_anno_i_1.onpointerdown=async function() { //div_outdoor
      document.getElementsByClassName("container")[0].style.display="flex";
...
document.getElementsByClassName("btn-1-1")[0].style.visibility="hidden";
document.getElementsByClassName("btn-3")[0].style.visibility="hidden";
document.getElementsByClassName("btn-6")[0].style.visibility="visible";
...
div_anno_i_2.onpointerdown=async function() { //div_outdoor_2
      document.getElementsByClassName("container")[0].style.display="flex";
...
div_anno_i_3.onpointerdown=async function() {
      document.getElementsByClassName("container")[0].style.display="flex";
...
div_anno_i_4.onpointerdown=async function() {
      document.getElementsByClassName("container")[0].style.display="flex";
...
div_anno_i_5.onpointerdown=async function() {
      document.getElementsByClassName("container")[0].style.display="flex";
